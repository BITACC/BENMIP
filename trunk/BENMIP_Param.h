...
#ifndef BENMIP_PARAM_INCLUDED
#define BENMIP_PARAM_INCLUDED
...
public:
   void getSettings(UtilParameters & utilParam){
      static const char * common = "BENMIP";
	  ...
	  MasterVarsFile = utilParam.GetSetting("MasterVarsFile", "", common);
   ...
   void dumpSettings(ostream * os = &cout){
      static const char * common = "BENMIP";
      (*os) << "\n=====================================================\n"
            << "BENMIP_DECOMP PARAMETER SETTINGS \n";
